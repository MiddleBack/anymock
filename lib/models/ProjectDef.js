    ...
    cb && getActiveDef(function (defs, err) {
        ...
        if (!err) {
            Object.getOwnPropertyNames(defs).forEach(function (propertyName) {
                var _interfaceDef = defs[propertyName];
                _interfaceDef.active && _interfaceDef.prjInterfaces && Object.getOwnPropertyNames(_interfaceDef.prjInterfaces).forEach(function (interfacePath) {
