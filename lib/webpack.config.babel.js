...
module.exports = {
    ...
    module: {
        ...
        // https://github.com/webpack/extract-text-webpack-plugin 单独引入css文件
        {
            test: /\.less/,
            exclude: /node_modules/,
            loader: _extractTextWebpackPlugin2.default.extract('style-loader', 'css-loader!autoprefixer-loader?{browsers:["IE >= 8"]}!less-loader')
        },
        // https://github.com/webpack/extract-text-webpack-plugin 单独引入css文件
        {
            test: /\.css$/,
    ...
    plugins: [new _webpack2.default.optimize.OccurenceOrderPlugin(), new _webpack2.default.HotModuleReplacementPlugin(), new _extractTextWebpackPlugin2.default('[name].css'), new _webpack2.default.NoErrorsPlugin() /*,
