 ...
 */
var appPath = _path2.default.resolve(__dirname, 'client');
//测试环境
var ip = '127.0.0.1';
var port = 8020;
...
module.exports = {
    ...
    plugins: [new _webpack2.default.optimize.OccurenceOrderPlugin(), new _webpack2.default.HotModuleReplacementPlugin(), new _webpack2.default.NoErrorsPlugin(), new _webpack2.default.DllReferencePlugin({
        context: __dirname,
        /**
         * 在这里引入 manifest 文件
         */
