...
var SERVER_STATUS_URL = '/api/proxy/status';
...
var ProxyStart = function (_React$Component) {
    ...
    _createClass(ProxyStart, [{
        ...
        value: function componentDidMount() {
            ...
            //获取服务器的启动状态
            _fetch2.default.get(SERVER_STATUS_URL).then(function (reps) {
        ...
        value: function stopServer() {
            ...
            _fetch2.default.post(STOP_SERVER_URL).then(function (json, response) {
                _this4.setState((0, _merge2.default)(_this4.state, {
                    proxyServerState: PROXY_SERVER_STATE.STOPED
                }));
            }).catch(function (e) {
                _message2.default.error(e.message);
        ...
        key: 'fetchDataTest',
        value: function fetchDataTest() {
            _fetch2.default.post('http://10.13.73.60:8001/wc/productList').then(function (json, response) {
                _message2.default.success('获取数据成功！');
            }).catch(function (e) {
                _message2.default.error('获取数据异常！');
            });
        }
    }, {
        key: 'render',
