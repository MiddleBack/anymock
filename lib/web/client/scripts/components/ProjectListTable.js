            ...
            var TABLE_COLUMNS = [{
                ...
                render: function render(text, record, index) {
                    return record.edit ? _react2.default.createElement(
                        _form2.default.Item,
                        null,
                        _react2.default.createElement(_input2.default, _extends({ defaultValue: record.prjPath || '' }, getFieldProps('prjPath')))
                    ) : _react2.default.createElement(
                        'span',
                        null,
                        text || ''
                ...
                render: function render(text, record, index) {
                    return record.edit ? _react2.default.createElement(
                        ...
                        onChange: function onChange() {
                            return _this3.props.onToggleProjectActive && _this3.props.onToggleProjectActive(text, record, index);
                        } });
                }
            }, {
                title: '操作',
